...
p*b,0):d===e.month?c.makeTime(q,y+p*b):!v||d!==e.day&&d!==e.week?v&&d===e.hour&&1<b?c.makeTime(q,y,J,l+p*b):t+d*b:c.makeTime(q,y,J+p*b*(d===e.day?1:7)),p++;h.push(t);d<=e.hour&&1E4>h.length&&F(h,function(a){0===a%18E5&&"000000000"===c.dateFormat("%H%M%S%L",a)&&(k[a]="day")})}h.info=I(a,{higherRanks:k,totalRange:d*b});return h}}})(K);(function(a)


{var C=a.color,F=a.merge;a.defaultOptions={colors:"#9FC9C6 #434348 #90ed7d #f7a35c #8085e9 #f15c80 #e4d354 #2b908f #f45b5b #91e8e1".split(" "),symbols:["circle",
...
pointFormat:'\x3cspan style\x3d"color:{point.color}"\x3e\u25cf\x3c/span\x3e {series.name}: \x3cb\x3e{point.y}\x3c/b\x3e\x3cbr/\x3e',shadow:!0,style:{color:"#333333",cursor:"default",fontSize:"12px",pointerEvents:"none",whiteSpace:"nowrap"}},credits:{enabled:!0,href:"",position:{align:"right",x:-10,verticalAlign:"bottom",y:-5},style:{cursor:"pointer",color:"#999999",fontSize:"9px"},text:""}};a.setOptions=function(C){a.defaultOptions=F(!0,a.defaultOptions,C);
...
// GEOLOGIA
  ...
  'liv-1geo': {
    duration: 5000,
    center: [9.628540623079488, 45.71600030252526],
    zoom: 12,
    // speed: 0.6,
    pitch: 0,
  ...
  'liv-geo2': {
    // duration: 5000,
    // center: [9.649222835408523, 45.72571600533058],
    // zoom: 13,
    // pitch: 20,
    coordinate:[
      [
  ...
  'liv-geo3': {
    // duration: 5000,
    // center: [9.630699388892822, 45.708933565424445],
    // zoom: 13,
    // pitch: 20,
    coordinate: [
      [
    ...
    'liv-geo3-2': {
      // duration: 5000,
      // center: [9.687469200116699, 45.72584639715879],
      // zoom: 13,
      // pitch: 20,
      coordinate: [
        [
  ...
  'liv-geo4': {
    // duration: 5000,
    // center: [9.611932921960147, 45.70787096523563],
    // zoom: 13,
    // pitch: 20,
    coordinate: [
      [
